...
module.exports = [
    ...
    { name: 'Energy Drain', text: 'Attack 1, Cure = damage dealt', elements: 'FW', effects: [{type: actions.DRAIN, value: 1}], targeted: true, copies: 3 },
    ...
    // { name: 'Fist of Flame', text: 'Attack 1, Burn 3', elements: 'FFE', effects: [{type: actions.ATTACK, value: 1}, {type: actions.HP_MINUS, value: 3}], targeted: true, copies: 2},
    // { name: 'Flamethrower', text: 'Attack 3', elements: 'FFF', effects: [{type: actions.ATTACK, value: 3}], targeted: true, copies: 2},
    // { name: 'Jet of Steam', text: 'Attack 2, Obscure 1', elements: 'FFW', effects: [{type: actions.ATTACK, value: 2}, {type: actions.OBSCURE, value: 1}], targeted: true, copies: 2},
    ...
    // { name: 'Life Drain', text: 'Attack 2, Cure = damage dealt', elements: 'WWF', effects: [{type: actions.ATTACK, value: 2}/*, {type: actions.DRAIN, value: 2}*/], targeted: true, copies: 2},
    ...
    // { name: 'Fusion', text: 'Attack 4', elements: 'FFFF', effects: [{type: actions.ATTACK, value: 4}], targeted: true, copies: 1},
    // { name: 'Medicine', text: 'Cure 3, Divine 2', elements: 'WWWW', effects: [{type: actions.CURE, value: 3}, {type: actions.DIVINE, value: 2}], targeted: false, copies: 1},
    // { name: 'Napalm', text: 'Burn 3 to all opponents', elements: 'AAEE', effects: [{type: actions.HP_MINUS, value: 3}], targeted: false, copies: 1},
    // { name: 'Meteor', text: 'Attack 2, then Attack 1 to all opponents (including original target)', elements: 'AAFF', effects: [{type: actions.ATTACK, value: 2}, /*Attack 1 and then all*/{type: actions.ATTACK_ALL, value: 1}], targeted: true, copies: 1},
    // { name: 'Third Eye', text: 'Divine 4, then Weave twice', elements: 'AAWW', effects: [{type: actions.DIVINE, value: 4}, {type: actions.WEAVE}, {type: actions.WEAVE}], targeted: false, copies: 1},
    // { name: 'Immolate', text: 'Burn 5', elements: 'EEFF', effects: [{type: actions.HP_MINUS, value: 5}], targeted: true, copies: 1},
    // { name: 'Adaptation', text: 'Regen 5', elements: 'EEWW', effects: [{type: actions.HP_PLUS, value: 5}], targeted: false, copies: 1},
    // { name: 'Soul Drain', text: 'Attack 3, Cure = damage dealt', effects: [{type: actions.ATTACK, value: 3}/*, {type: actions.DRAIN, value: 3}*/], targeted: true, copies: 1},
    ...
    // //magnetize strips -1 HP token to all opponents and keeps them... needs fix
    // { name: 'Magnetize', text: 'Shield 3, Regen 2, strip up to 1 +HP token from all opponents and take them for yourself', elements: 'EEEX', effects: [{type: actions.SHIELD, value: 2}, {type: actions.HP_PLUS, value: 2}], targeted: false, copies: 1},
    // //firestorm does -2 HP burn to all opponents...
    // { name: 'Firestorm', text: 'Attack 1, Burn 2 to all opponents', elements: 'FFFX', effects: [{type: actions.ATTACK, value: 1}], targeted: true, copies: 1},
    // //upwelling MAY obscure UP TO 2 cards... how do we manage if they don't want to? 
    // { name: 'Upwelling', text: 'Cure 2, Regen 4, then you may Obscure up to 2 cards', elements: 'WWWX', effects: [{type: actions.CURE, value: 2}, {type: actions.HP_PLUS, value: 4}, {type: actions.OBSCURE, value: 2}], targeted: false, copies: 1},
    // //apotheosis is -1 AP to all opponents
    // { name: 'Apotheosis', text: 'Attack 1 and AP -1 to all opponents, Cure 1, AP +1, Regen 1, Shield 1', elements: 'AEFWX', effects: [{type: actions.ATTACK, value: 1}, {type: actions.CURE, value: 1}, {type: actions.AP_PLUS, value: 1}, {type: actions.HP_PLUS, value: 1}, {type: actions.SHIELD, value: 1}], targeted: true, copies: 1}, 
