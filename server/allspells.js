...
module.exports = [
    ...
    { name: 'Meteor', text: 'Attack 2, then Attack 1 to all opponents (including original target)', elements: 'AAFF', effects: [{type: actions.ATTACK, value: 2, targetPlayer: true}, {type: actions.ATTACK_ALL, value: 1}], targeted: true, copies: 1},
    ...
    // { name: 'Magnetize', text: 'Shield 3, Regen 2, strip up to 1 +HP token from all opponents and take them for yourself', elements: 'EEEX', effects: [{type: actions.SHIELD, value: 2}, {type: actions.HP_MINUS, value: 2}], targeted: false, copies: 1},
    // //firestorm does -2 HP burn to all opponents...
    // { name: 'Firestorm', text: 'Attack 1, Burn 2 to all opponents', elements: 'FFFX', effects: [{type: actions.ATTACK, value: 1, targetPlayer: true}, {type: actions.HP_MINUS, value: 2}], targeted: true, copies: 1},
    // //upwelling MAY obscure UP TO 2 cards... how do we manage if they don't want to? 
    // { name: 'Upwelling', text: 'Cure 2, Regen 4, and Obscure 2 cards', elements: 'WWWX', effects: [{type: actions.CURE, value: 2}, {type: actions.HP_PLUS, value: 4}, {type: actions.OBSCURE, value: 2}], targeted: true, copies: 1},
    // //apotheosis is -1 AP to all opponents
    // { name: 'Apotheosis', text: 'Attack 1 and AP -1 to all opponents, Cure 1, AP +1, Regen 1, Shield 1', elements: 'AEFWX', effects: [{type: actions.ATTACK, value: 1, targetPlayer: true}, {type: actions.AP_MINUS, value: 1}, {type: actions.CURE, value: 1}, {type: actions.AP_PLUS, value: 1}, {type: actions.HP_PLUS, value: 1}, {type: actions.SHIELD, value: 1}], targeted: true, copies: 1}, 
